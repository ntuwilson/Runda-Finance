...
export function LoanCard({ loan }: { loan: LoanProduct }) {
  return (
    <Reveal className="h-full">
      <article className="flex h-full flex-col rounded-md border border-[#e4e8f4] bg-white p-5 transition hover:-translate-y-0.5 hover:border-[#263479] hover:bg-[#eef1ff] hover:shadow-sm">
