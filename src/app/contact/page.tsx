      ...
      <Section eyebrow="Contact details" title="Official contact channels">
        <div className="grid gap-5 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="rounded-xl border border-[#e5e7eb] bg-white p-6 text-sm leading-7 text-[#475467]">
            <p><strong className="font-medium text-[#111827]">Office:</strong> {siteDetails.address}</p>
            <p><strong className="font-medium text-[#111827]">Phone:</strong> {siteDetails.phones.join(", ")}</p>
            <p><strong className="font-medium text-[#111827]">Email:</strong> {siteDetails.email}</p>
            <p><strong className="font-medium text-[#111827]">Working hours:</strong> {siteDetails.hours}</p>
            <p><strong className="font-medium text-[#111827]">Social links:</strong> Active verified links only.</p>
          </div>
          <div className="flex min-h-72 items-center justify-center rounded-xl border border-dashed border-[#c8cdd5] bg-[#f5f5f7] text-sm font-medium text-[#667085]">
            [Map Embed]
          </div>
        </div>
      </Section>
