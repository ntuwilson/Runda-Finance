    ...
    <>
      ...
      <Section eyebrow="Terms draft" title="Website usage terms">
        <div className="rounded-md border border-[#e4e8f4] bg-white p-6 text-sm leading-7 text-[#3f4656]">
          <h2 className="text-2xl font-medium text-[#050505]">General information</h2>
          ...
          <h2 className="mt-8 text-2xl font-medium text-[#050505]">Applications</h2>
          ...
          <h2 className="mt-8 text-2xl font-medium text-[#050505]">Approval</h2>
          ...
          <h2 className="mt-8 text-2xl font-medium text-[#050505]">Website misuse</h2>
