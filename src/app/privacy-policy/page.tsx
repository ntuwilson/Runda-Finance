  ...
  return (
    <>
      ...
      <Section eyebrow="Policy draft" title="How customer information is handled">
        <div className="prose prose-slate max-w-none rounded-xl border border-[#e5e7eb] bg-white p-6 text-sm leading-7 text-[#475467]">
          <h2 className="text-2xl font-medium text-[#111827]">Information collected</h2>
          ...
          <h2 className="mt-8 text-2xl font-medium text-[#111827]">Why information is collected</h2>
          ...
          <h2 className="mt-8 text-2xl font-medium text-[#111827]">Who may access it</h2>
          ...
          <h2 className="mt-8 text-2xl font-medium text-[#111827]">Security and retention</h2>
          ...
          <h2 className="mt-8 text-2xl font-medium text-[#111827]">Privacy contact</h2>
